...
public class ReralopesTests {
	...
	@Test
	// Verificamos que el ataque normal hace el daño base (27 puntos), y el ataque
	// potenciado (después de descansar) hace el doble de daño (54 puntos).
	...
	@Test
	// Verificamos que después de 3 ataques potenciados, los ataques vuelven a su
	// valor normal.
