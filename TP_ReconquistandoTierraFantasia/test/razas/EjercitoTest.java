...
public class EjercitoTest {
	...
	@Test
	// La primera unidad formada del ejercito ataca a la primera unidad formada del
	// otro ejercito
	// hasta que uno de los ejercitos no tenga unidades
	// si el ejercito que llama al metodo pierde, devuelve false, si gana, devuelve
	// true
	public void batalla() {
		Ejercito ejercito = new Ejercito("Wrives", 1);
	...
	public void descansar() {
		...
		// el Wrives propio pierde 124 de salud, porque el Radaiteran lo ataca una vez
		// cuando antes ya hizo un ataque
		// (56 + 3) * 2 = 118
		ejercito.batalla(enemigo);
