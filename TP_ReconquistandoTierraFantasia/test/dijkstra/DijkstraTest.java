...
public class DijkstraTest {
	...
	public void resolver() {
		...
		int[][] resultadoEsperado0 = {{Integer.MAX_VALUE, 0, Integer.MAX_VALUE, 2},
										{-1, -1, -1, 1}};
		...
		int[][] resultadoEsperado1 = {{Integer.MAX_VALUE, 2, 0, 4},
									{-1, 2, -1, 1}};
	...
	public void devolverCamino () {
		int[] predecesores = {-1, 2, 0, 1},
				resultado,
				resultadoEsperado = {0, 2, 1, 3};
